...
public class HorizontalAlignerTest {
    private final BoundingBox[] boxes;
    private final BoundingBox[] expectedBoxes;
    private Aligner aligner;

    public HorizontalAlignerTest(BoundingBox[] boxes, BoundingBox[] expectedBoxes) {
        this.boxes = boxes;
        this.expectedBoxes = expectedBoxes;
    }

    @Before
    public void createHorizontalAligner() {
        aligner = new HorizontalAligner();
    }
    ...
    public static Collection<Object[]> data() {
        ...
        data.add(new Object[]{
                ...
                new BoundingBox[]{ new BoundingBox(0, 0, 1, 1), new BoundingBox(1, 0, 1, 1) }});
        data.add(new Object[]{
                new BoundingBox[]{ new BoundingBox(0, 0, 1, 1), new BoundingBox(0, 0, 2, 2), new BoundingBox(0, 0, 1, 1) },
                new BoundingBox[]{ new BoundingBox(0, 0, 1, 1), new BoundingBox(1, 0, 2, 2), new BoundingBox(3, 0, 1, 1) }});
        return data;
    }
}

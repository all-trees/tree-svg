...
public class Configuration {
    ...
    public static Configuration configuration(){
        return new Configuration(DEFAULT_NODE_RADIUS, DEFAULT_LEAF_RADIUS, DEFAULT_PADDING, DEFAULT_STROKE, DEFAULT_FILL, DEFAULT_STROKE_WIDTH);
    }
    ...
    public Configuration(int nodeRadius, int leafRadius, int padding, String stroke, String fill, int strokeWidth) {
    ...
    public Configuration withNodeRadius(int nodeRadius) {
        return new Configuration(nodeRadius, leafRadius, padding, DEFAULT_STROKE, DEFAULT_FILL, DEFAULT_STROKE_WIDTH);
    }
    ...
    public Configuration withStroke(String stroke) {
        return new Configuration(nodeRadius, leafRadius, padding, stroke, fill, strokeWidth);
    }
